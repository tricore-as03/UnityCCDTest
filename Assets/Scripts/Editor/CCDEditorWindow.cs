...
public class CCDEditorWindow : EditorWindow
{
    ...
    // NOTE : Jsonで外部管理すべき
    private string apiKey = "47529b137793720bcd4d8fa938fd1912";
    ...
    private const string DevelopmentIOSBucketId = "19f9dfba-c81b-41c9-93c9-0db311ccf233";
    private const string ProductionIOSBucketId = "8942a71c-7ebe-4a79-9094-4ba73f9e976a";
    ...
    private async UniTask UploadAssets()
    {
        ...
        var commands = new string[]
        {
            ...
            $"config set bucket {DevelopmentIOSBucketId}",
